        ...
        for i = 1, 5 do
            ...
            if data.log[i].none then
                ...
                text:SetText(
                    "|cF49B22" ..
                        data.log[i].time ..
                            " :  |CFFFFFF" .. zo_strformat("<<1>>", ZO_LocalizeDecimalNumber(data.log[i].amount)) .. " |t14:14:EsoUI/Art/currency/currency_gold.dds|t"
                )
            end
        end
        ...
        total2:SetText(
            "|C11d936" ..
                ITTsDonationBot:parse("TIME_THIS_WEEK") ..
                    ": " .. "|CFFFFFF" .. zo_strformat("<<1>>", ZO_LocalizeDecimalNumber(data.thisWeek)) .. " |t14:14:EsoUI/Art/currency/currency_gold.dds|t "
        )
        ...
        total3:SetText(
            "|C11d936" ..
                ITTsDonationBot:parse("TIME_LAST_WEEK") ..
                    ": " .. "|CFFFFFF" .. zo_strformat("<<1>>", ZO_LocalizeDecimalNumber(data.lastWeek)) .. " |t14:14:EsoUI/Art/currency/currency_gold.dds|t "
        )
        ...
        total4:SetText(
            "|C11d936" ..
                ITTsDonationBot:parse("TIME_PRIOR_WEEK") ..
                    ": " .. "|CFFFFFF" .. zo_strformat("<<1>>", ZO_LocalizeDecimalNumber(data.priorWeek)) .. " |t14:14:EsoUI/Art/currency/currency_gold.dds|t "
        )
...
function Roster:Enable(enable)
    ...
    local donationsSelectionTotal = CreateControlFromVirtual(guildRoster:GetName() .. "DonationsSelectionTotal", donationsTotal, "ZO_KeyboardGuildRosterRowLabel")
        ...
        LibGuildRoster:AddColumn(
        {
            ...
            row = {
                ...
                format = function(value)
                    return zo_strformat("<<1>>", ZO_LocalizeDecimalNumber(tonumber(value) or 0)) .. " |t15:15:EsoUI/Art/currency/currency_gold.dds|t"
                end,
    ...
    LibGuildRoster:OnRosterReady(
        function()
            ...
            donationsDays:SetAnchor(TOPLEFT, donationsColumn:GetHeader(), BOTTOMLEFT, 0, ZO_GuildRoster:GetHeight())
            donationsDays:SetAnchor(TOPLEFT, donationsColumn:GetHeader(), BOTTOMLEFT, 0, 566)
            -- local _,_,_,_,offsetX,offsetY = donationsColumn:GetHeader():GetAnchor(0)
            -- donationsDays:SetAnchor(TOPLEFT, ZO_GuildRosterList, BOTTOMLEFT, offsetX, -20)
